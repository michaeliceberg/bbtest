...
export const STEP_BY_STEP_CHALLENGE_TYPES = new Set(['SINWALK', 'LOGWALK', 'LOGDEFWALK', 'LOGSUBWALK', 'LOGPOWWALK', 'LOGSWAPWALK', 'LOGDIVWALK', 'LOGCOMBOWALK', 'LOGFLIPWALK', 'FARADAYWALK', 'DIRWALK', 'SINCOSDEFWALK', 'LEGFINDWALK', 'TRIGSCWALK', 'TRIGTGWALK']);
