...
const RULES_BY_UNIT: Record<number, UnitRules> = {
	...
	6: {
		...
		name: {
			...
			'средняя энергия теплового движения молекулы': 'molecule-motion',
			'кинетическая энергия молекулы': 'molecule-motion',
			'средняя квадратичная скорость молекул': 'molecule-motion',
		...
		symbol: [
			...
			{ pattern: /E_\{кин\}/, sticker: 'molecule-motion' },
			{ pattern: /<v>/, sticker: 'molecule-motion' },
			...
			{ pattern: bare('E'), sticker: 'molecule-motion' },
		],
	},
