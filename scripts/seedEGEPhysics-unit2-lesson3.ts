// scripts/seedEGEPhysics-unit2-lesson3.ts
//
// Курс "ЕГЭ Физика" — Unit 2 "Динамика", урок 3
// (42 задачи с https://phys-ege.sdamgia.ru/test?theme=213:
...
const challenges: ChallengeSeed[] = JSON.parse(
    readFileSync('/tmp/phys204_work/challenges213.json', 'utf-8')
);
...
const main = async () => {
    try {
        console.log('Seeding: ЕГЭ Физика → Unit 2 → Динамика → Урок 3');
