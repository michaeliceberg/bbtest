// scripts/seedEGEPhysics-unit2-lesson5.ts
//
// Курс "ЕГЭ Физика" — Unit 2 "Динамика", урок 5
// (29 задач с https://phys-ege.sdamgia.ru/test?theme=215:
...
const challenges: ChallengeSeed[] = JSON.parse(
    readFileSync('/tmp/phys204_work/challenges215.json', 'utf-8')
);
...
const main = async () => {
    try {
        console.log('Seeding: ЕГЭ Физика → Unit 2 → Динамика → Урок 5');
