...
export type allTypesCT = "M_ASC" | "SELECT" | "ASSIST" | "CONNECT" | "SLIDER" | "CONSTRUCT" | "WORKBOOK" | "R ASSIST" | "R CONNECT" | "R SLIDER" | "GEOSIN" | "RUSSIANDICTANT" | "SWIPE" | "KEYBOARD" | "INSERT" | "SCROLL" | "HOT" | "CHECK" | "PICMATCH" | "MULTISTEP" | "SPEED" | "FRACTRICK" | "DIAGRAM" | "TRIGTABLE" | "UNITCIRCLE" | "VIETA" | "SINWALK";
...
export const t_challengesEnum = pgEnum("type", [
	"M_ASC", "SELECT", "ASSIST", "CONNECT", "SLIDER", "CONSTRUCT", "WORKBOOK",
	"R ASSIST", "R CONNECT", "R SLIDER", "GEOSIN", "RUSSIANDICTANT", "SWIPE", "KEYBOARD",
	"INSERT", "SCROLL", "CHECK", "PICMATCH", "MULTISTEP", "SPEED", "FRACTRICK", "DIAGRAM", "TRIGTABLE", "UNITCIRCLE", "VIETA", "SINWALK"
]);
