...
// // В ваш TrainerQuestion компонент добавьте:
...
//   } else if (timeLeft === 0) {
//     setMascotEmotion("sad")
//   } else if (mascotEmotion !== "thinking") {
...
//     {/* Верхняя панель с талисманом и прогрессом */}
//     <div className="relative">
//       <div className="grid grid-cols-12 gap-4 items-center">
//         {/* Левая часть - сердечки */}
//         <div className="col-span-3">
//           {/* Hearts будут переданы из родителя */}
//         </div>
...
//           {/* Ваш существующий таймер */}
//         </div>
//       </div>
      
//       {/* Остальной ваш JSX с вопросом и ответами */}
//     </div>
//   </div>
// )}
