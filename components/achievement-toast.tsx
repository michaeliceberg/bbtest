...
// key={achievement.id} на motion.div — ремаунт на КАЖДОЕ новое достижение
// из очереди (см. store/use-achievement-store.ts), без AnimatePresence:
// в этом проекте AnimatePresence уже не раз давала зависшую exit-анимацию
// (см. CLAUDE.md), а таймер закрытия ниже и так не зависит от завершения
// анимации — обычный key-ремонт достаточен и надёжнее.
