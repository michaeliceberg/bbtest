...
//     isDisabled: boolean,
//     missedLIds: number[],
//     isInQuest?: boolean,  // ← новый пропс для квеста
// }
...
//     // Проверяем, нужно ли показывать пончик квеста
//     const showQuestDonut = isInQuest && percentage < 100;
//     // Проверяем, нужно ли показывать HW иконку
//     const showHwIcon = missedLIds.includes(t_lesson.id);
...
//                                     : 'default'
//                             }
//                             className="h-[70px] w-[70px] border-b-8 group relative overflow-hidden px-4 py-2 transition-colors"
//                         >
//                             {percentage > 90 && (
//                                 <motion.span
//                                     initial={{ y: "100%" }}
...
//                                 />
//                             ) : (
//                                 <Lock className={cn("h-10 w-10", 'text-primary-foreground')} />
//                             )}
//                         </Button>
//                     </CircularProgressbarWithChildren>

//                     {/* 🍩 ПОНЧИК ДЛЯ КВЕСТА (справа сверху) */}
//                     {showQuestDonut && !showHwIcon && (
//                         <Image 
//                             src={'/hwSvgs/donut.svg'}
//                             height={32}
...
//                     {/* Если есть и квест, и HW - показываем оба */}
//                     {showQuestDonut && showHwIcon && (
//                         <Image 
//                             src={'/hwSvgs/donut.svg'}
//                             height={28}
