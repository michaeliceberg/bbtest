...
// (не таймер на каждый отдельный вопрос): стартует с 12 секунд, тратится
// непрерывно, +3с за верный ответ, дополнительно −1с за неверный.
...
const TICK_MS = 100
const FLASH_MS = 180
const BAR_VISUAL_MAX = 15 // секунд — при большем банке бар просто остаётся полным
