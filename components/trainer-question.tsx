  ...
  const renderQuestionContent = () => {
    ...
    const renderImage = () => {
      if (question.imageSrc && question.imageSrc !== '0') {
        ...
        // контентом, увеличение безопасно. 190 тоже оказалось мелко по
        // прямой просьбе пользователя ("только БОЛЬШИЕ картинки — на них
        // намного нагляднее") — увеличено ещё раз.
        return (
          <Image
