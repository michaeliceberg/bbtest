  ...
  const renderQuestionContent = () => {
    ...
    const renderImage = () => {
      if (question.imageSrc && question.imageSrc !== '0') {
        ...
        // контентом, увеличение безопасно. 190, затем 280 тоже оказались
        // мелкими по прямой жалобе пользователя ("тут очень много пустого
        // пространства, а рисунок маленький" — карточка вопроса ~540px
        // шириной, картинка использовала из них едва половину). w-full +
        // max-w — чтобы на узком (мобильном) экране не вылезало за карточку.
        return (
          <Image
            className="pt-8 mx-auto w-full max-w-[440px] h-auto"
