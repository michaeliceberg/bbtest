...
// ACCENT выше — НЕ из «Палитры ggege»: это отдельный, самостоятельный
// акцент математических sdamgia-диаграмм (scripts/svg-tools), используемый
// в сотнях уже существующих статичных SVG курса — трогать его здесь
// означало бы расходиться с тем массивом файлов (см. CLAUDE.md «Палитра
// ggege — что НЕ входит»).
//
...
// яркости, сливается. Оранжевый из «Палитры ggege» — тот же цвет, что
// теперь и у BlinkingExclaim ("смотри сюда" в WalkthroughLog.tsx) —
// контрастен и к тёмному фону, и к белым линиям трапеции.
const LEGS_HIGHLIGHT_COLOR = GGEGE_PALETTE.orange.button
// Отрезки основания — зелёный из палитры, чётко другой цвет, не
// сливается с оранжевой подсветкой боковых сторон выше.
const SEGMENT_COLOR = GGEGE_PALETTE.green.button
const HYPOTENUSE_COLOR = GGEGE_PALETTE.purple.button // тот же фиолетовый, что и текст-маркер — "вот что мы сейчас ищем"
const TEXT = '#F2F7FB'
