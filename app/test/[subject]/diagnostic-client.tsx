...
// просьбе пользователя: <20 "тошнит", <40 грустный, <80 "норм", 80+
// довольный (границы "норм" и "тошнит" — отдельные более поздние правки,
// не совпадают с первой версией).
const targetScoreEmoji = (score: number) => (score < 20 ? '🤢' : score < 40 ? '😟' : score < 80 ? '🙂' : '😄');
