...
//                 // 🔥 Используем уже полученный t_lessonProgress (не делаем новый запрос!)
//                 const completedIds = t_lessonProgress
//                     .filter(lp => lessonIds.includes(lp.t_lessonId) && lp.doneRightPercent === 100)
//                     .map(lp => lp.t_lessonId);
...
// 				questWithLessons = {
//                     ...quest,
//                     isCompleted: quest.isCompleted === true, // ← преобразуем null в false
//                     lessons: questLessons.map(l => ({
//                         id: l.id,
//                         title: l.title,
//                         completed: completedIds.includes(l.id),
...
//             {/* Квест тренажера - передаем только данные, без функций */}
//             {activeTCourse && questWithLessons && (
//                 <TrainerQuestCard 
//                     quest={questWithLessons}
//                     streak={streak}
//                     // onLessonClick не передаем из server component
//                 />
//             )}
//         </StickyWrapper>
...
//                     all_t_lessonProgress={all_t_lessonProgress}
//                     this_class_id={userProgress.classId}
// 					questLessonIds={questLessonIds}  // ← передаем
//                 />
//             </FeedWrapper>
//     </div>
// );
