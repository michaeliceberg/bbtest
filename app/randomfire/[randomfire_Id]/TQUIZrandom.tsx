...
import { ArrowLeft, X, Baby, Crown, Pizza } from "lucide-react"
  ...
  if (!quizStarted) {
    return (
      <div className="text-center content-center mx-auto">
        ...
        {/* <LottiePlayer
          src={randomStartLottie}
          autoplay={isPlaying} // Controls whether the animation plays
          loop={false} // Set to true if you want it to loop after playing
